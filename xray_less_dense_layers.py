...
def optimize_hyperparameters():
	...
	fmin(get_average_cross_validation_accuracy, feature_space, algo=tpe.suggest, max_evals=20)
...
def implement_optimum_model(parameter_tuple):
	...
	save_keras_model(model, "optimum_xray_less_dense.json","optimum_xray_less_dense.h5")

if __name__ == "__main__":
	#optimize_hyperparameters()
	#implement_optimum_model(best_hyper_parameter_tuple)
	#implement_optimum_model((4, 3, 'adam', 'relu'))
	model = load_keras_model("optimum_xray_less_dense.json","optimum_xray_less_dense.h5")
	print("Model summary:")
	print(model.summary())
	...
	predictions = predictions.reshape(94)
	print(predictions)
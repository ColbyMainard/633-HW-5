"""
    Credit: https://github.com/jundongl/scikit-feature
"""
import numpy as np
import feature_extraction_image_preprocessing as feature
...
if __name__ == '__main__':
    gray_scale_feature = feature.getFeature('gray_scale')
    label = []
    data = []
    for i in gray_scale_feature:
        label.append(i[0])
        data.append(i[1])
